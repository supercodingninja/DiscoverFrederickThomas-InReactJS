...
import pdf from '../../Assets/profileResume_07-03-22.docx';
import pdf2 from '../../Assets/Frederick%20Thomas_CV_2022.docxf';
        ...
        <Row className='resume'>
          <Col md={6} className='resume-left'>
            ...
            <Resumecontent
              ...
              content={[
                `I went through a rigourous and rewarding training program at the University of Washington (UW) Professional and Continuing Education Program, conducted by Trilogy Education Services (a 2U, Inc. brand); which helped me become first, a front-end developer; and then a Full-Stack Web Developer (MERN).  I am taking advantage of their contunation courses (AWS, C#, Python, and Java).  This by far, the best and most structure and elaborate Coding Bootcamp I have ever attended.  I plan to earn cetificates from Harvard Extension School; and build an alternative online video platform for Christian Ministers and Schools!`,
              ]}
            />
